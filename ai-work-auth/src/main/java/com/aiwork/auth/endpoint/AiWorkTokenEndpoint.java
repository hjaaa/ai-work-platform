...
import com.aiwork.admin.api.vo.TokenVO;
import com.aiwork.auth.support.core.AuthCaptchaSupport;
import com.aiwork.auth.support.core.OauthClientDetailsLoader;
import com.aiwork.auth.support.core.AuthErrorCodes;
...
import com.aiwork.common.security.util.OAuth2ErrorCodesExpand;
import com.aiwork.common.security.util.OAuthClientException;
...
public class AiWorkTokenEndpoint {

	private static final String DEFAULT_FORM_CLIENT_ID = "ai-work";
