package com.aiwork.auth.support.base;

import cn.hutool.core.util.BooleanUtil;
import cn.hutool.extra.spring.SpringUtil;
import com.aiwork.common.core.constant.CommonConstants;
import com.aiwork.common.security.service.AiWorkRedisOAuth2AuthorizationService;
import com.aiwork.common.security.util.OAuth2ErrorCodesExpand;
import com.aiwork.common.security.util.ScopeException;
...
public abstract class OAuth2ResourceOwnerBaseAuthenticationProvider<T extends OAuth2ResourceOwnerBaseAuthenticationToken>
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		try {
			...
			AiWorkRedisOAuth2AuthorizationService redisOAuth2AuthorizationService = (AiWorkRedisOAuth2AuthorizationService) this.authorizationService;
