...
import com.aiwork.auth.support.filter.AuthSecurityConfigProperties;
 ...
 * @since 1.0.0
 */
public class AiWorkDaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
	 ...
	 */
	public AiWorkDaoAuthenticationProvider() {
	...
	protected void additionalAuthenticationChecks(UserDetails userDetails,
		...
		if (configProperties.isExpirePassword() && userDetails instanceof AiWorkUser aiworkUser
				&& Objects.nonNull(aiworkUser.getPasswordModifyTime())) {
			Long expireDays = ParamResolver.getLong("PASSWORD_EXPIRE_DAYS", 90L);
			long daysBetween = ChronoUnit.DAYS.between(aiworkUser.getPasswordModifyTime(), LocalDateTime.now());
	 ...
	 * null
	 * @see AiWorkUserDetailsService#support(String, String)
	 */
	@SneakyThrows
	@Override
	protected final UserDetails retrieveUser(String username, UsernamePasswordAuthenticationToken authentication) {
		...
		Map<String, AiWorkUserDetailsService> userDetailsServiceMap = SpringUtil
