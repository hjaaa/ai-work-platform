package com.aiwork.common.core.config;
...
import com.aiwork.common.core.jackson.AiWorkLongModule;
 ...
 * {@link com.aiwork.common.core.jackson.AiWorkJavaTimeModule}、默认时区等
 *
 * @author L.cm
 * @author lengleng
 * @author lishangbu
...
public class JacksonConfiguration implements WebMvcConfigurer {
	 ...
	 * customizer 注册的能力 （例如 ai-work-common-xss 的 String 反序列化 XSS 清洗）静默失效。
	 */
	@Bean
	public org.springframework.boot.jackson2.autoconfigure.Jackson2ObjectMapperBuilderCustomizer aiworkJackson2Customizer() {
		// 序列化能力按职责拆分到独立 module：
		// AiWorkJavaTimeModule —— Java 8 时间类型格式化
		// AiWorkLongModule —— Long/long -> String，防 JS 精度丢失
		return builder -> builder.locale(Locale.CHINA)
			...
			.modulesToInstall(new AiWorkJavaTimeModule(), new AiWorkLongModule())
			.featuresToDisable(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES,
					SerializationFeature.WRITE_DATES_AS_TIMESTAMPS);
	}

	/**
	 * 增加GET请求参数中时间类型转换 {@link com.aiwork.common.core.jackson.AiWorkJavaTimeModule}
	 * <ul>
	 ...
	 * {@link org.springframework.boot.jackson2.autoconfigure.Jackson2ObjectMapperBuilderCustomizer}
	 * （包括 ai-work-common-xss 的 {@code xssJacksonCustomizer}）处理过，因此本 converter 同时具备 XSS
	...
	public void extendMessageConverters(List<HttpMessageConverter<?>> converters) {
		...
		if (objectMapper == null) {
			...
			// ai-work-common-xss 的反序列化 XSS 清洗、Long->String、时间格式都会失效且难以察觉，
