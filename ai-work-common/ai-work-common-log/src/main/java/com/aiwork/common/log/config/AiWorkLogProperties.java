...
@Getter
@Setter
@ConfigurationProperties(AiWorkLogProperties.PREFIX)
public class AiWorkLogProperties {

	public static final String PREFIX = "aiwork.log";
	 ...
	 */
	@Value("${aiwork.log.exclude-fields:password,mobile,idcard,phone,accessSecret,tokenId,sign}")
