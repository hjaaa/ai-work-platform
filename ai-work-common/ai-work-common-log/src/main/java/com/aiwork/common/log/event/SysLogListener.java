...
package com.aiwork.common.log.event;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import com.aiwork.admin.api.dto.SysLogDTO;
...
public class SysLogListener implements InitializingBean {
	...
	private final AiWorkLogProperties logProperties;
	...
	public void afterPropertiesSet() {
		...
		JacksonSensitiveFieldUtil.registerCustomModule(new AiWorkJavaTimeModule());
	}
