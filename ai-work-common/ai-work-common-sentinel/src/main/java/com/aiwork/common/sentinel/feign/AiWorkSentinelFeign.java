package com.aiwork.common.sentinel.feign;
 ...
 * @date 2020/6/9
 */
public final class AiWorkSentinelFeign {

	private AiWorkSentinelFeign() {

	}

	public static AiWorkSentinelFeign.Builder builder() {
		return new AiWorkSentinelFeign.Builder();
	}
	...
	public static final class Builder extends Feign.Builder implements ApplicationContextAware {
		...
		@Override
		public AiWorkSentinelFeign.Builder contract(Contract contract) {
			...
			super.invocationHandlerFactory(new InvocationHandlerFactory() {
				...
				public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
					...
					if (void.class != fallback) {
						...
						return new AiWorkSentinelInvocationHandler(target, dispatch,
					...
					if (void.class != fallbackFactory) {
						...
						return new AiWorkSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
					}
					return new AiWorkSentinelInvocationHandler(target, dispatch);
				}
