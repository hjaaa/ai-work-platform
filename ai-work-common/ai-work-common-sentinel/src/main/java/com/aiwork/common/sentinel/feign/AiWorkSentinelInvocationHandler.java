 ...
 */
@Slf4j
public class AiWorkSentinelInvocationHandler implements InvocationHandler {
	...
	AiWorkSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			AiWorkSentinelInvocationHandler other = (AiWorkSentinelInvocationHandler) obj;
