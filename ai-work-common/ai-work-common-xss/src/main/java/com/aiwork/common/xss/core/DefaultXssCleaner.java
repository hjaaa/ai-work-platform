...
package com.aiwork.common.xss.core;

import cn.hutool.core.util.CharsetUtil;
import com.aiwork.common.xss.config.AiWorkXssProperties;
import com.aiwork.common.xss.utils.XssUtil;
...
public class DefaultXssCleaner implements XssCleaner {
	...
	private final AiWorkXssProperties properties;
	...
	public String clean(String bodyHtml) {
		...
		AiWorkXssProperties.Mode mode = properties.getMode();
		if (AiWorkXssProperties.Mode.escape == mode) {
			// html 转义
