...
- 日期:2026-07-17
- 状态:v15;v1~v5 经四轮整体评审定稿,v6 附实施规划与会话交接(§16),v8 补齐 Plan B(表管理与 DDL)设计细化,v9~v15 按 Plan B 七轮设计评审修订
...
- 项目删除在状态 CAS 为 DELETING **之前**取得同一项目双层 DDL 锁(§9.2),锁内重查项目状态后再转移——否则已通过 ACTIVE 校验的长 ALTER 会与项目删除交叉
